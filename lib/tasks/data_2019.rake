namespace :data_2019 do
  task :add_games => :environment do
    ...
    players_response = HTTParty.get('http://fantasy.espn.com/apis/v3/games/ffl/seasons/2019/segments/0/leagues/91115?view=mTeam', {headers: {"Cookie": "espn_s2=#{espn_s2}; SWID=#{swid};"}})
    games_response = HTTParty.get('https://fantasy.espn.com/apis/v3/games/ffl/seasons/2019/segments/0/leagues/91115?view=mMatchup', {headers: {"Cookie": "espn_s2=#{espn_s2}; SWID=#{swid};"}})
    year_season = Season.find_or_create_by(year: 2019) unless games_response.values.empty?
